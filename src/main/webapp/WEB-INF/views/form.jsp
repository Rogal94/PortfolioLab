...
<body>
<%@include file="/WEB-INF/views/jspf/headerForm.jspf"%>
                ...
                <div class="summary">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text">
                                    <span id="showQuantity"></span> ubrań w dobrym stanie dla dzieci</span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text">Dla fundacji "<span id="showInstitution"></span>"</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        ...
                        <div class="form-section--column">
                            <h4>Termin odbioru:</h4>
                            <ul>
                                <li><span id="showDate"></span></li>
                                <li><span id="showTime"></span></li>
